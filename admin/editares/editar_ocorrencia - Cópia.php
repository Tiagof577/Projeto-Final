...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($_POST['tipo_ocorrencia'])) {
    ...
    $id_ocorrencia = validate($_POST['id_ocorrencia']);
...
?>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="id_ocorrencia" name="id_ocorrencia" value="<?php echo $row['id_ocorrencia']; ?>" readonly>
      </div>
